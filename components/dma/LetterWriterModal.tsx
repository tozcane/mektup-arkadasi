...
export const LetterWriterModal: React.FC = () => {
  const { writingRecipient, closeWriterModal, sendLetter, stamps, user, hasReachedLetterLimit, setActiveTab } = useDMA();
    ...
    <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-md flex items-center justify-center p-4 overflow-y-auto">
      <div className="relative w-full max-w-3xl rounded-3xl bg-white border border-gray-200 shadow-2xl overflow-hidden flex flex-col my-8">
        ...
        {hasReachedLetterLimit ? (
          /* =========================================================
             POSTA ÇANTASI DOLU UYARI EKRANI (Aynı anda en fazla 2 mektup)
             ========================================================= */
          <>
            <div className="p-8 text-center space-y-6 flex-1 flex flex-col items-center justify-center my-6">
              <div className="w-20 h-20 rounded-full bg-rose-50 border border-rose-200 flex items-center justify-center text-rose-700 animate-bounce shadow-md">
                <AlertCircle className="w-10 h-10" />
              </div>

              <div className="space-y-3 max-w-lg">
                <h3 className="font-serif text-2xl font-bold text-gray-955">
                  📬 Posta Çantanız Dolu!
                </h3>
                <p className="text-base text-gray-700 font-semibold leading-relaxed font-sans">
                  Mektup Arkadaşı kulübü kuralları gereği, aynı anda **en fazla 2 mektubunuz** yolda süzülebilir.
                </p>
                <p className="text-sm text-gray-600 leading-relaxed font-typewriter">
                  Şu anda gönderdiğiniz ve alıcılara henüz ulaşmamış olan **2 aktif mektubunuz** bulunuyor. 
                  Bu mektuplar hedeflerine ulaşmadan yeni bir mektup kaleme alamazsınız. Yavaş teslimat heyecanı sabretmeyi gerektirir! 🕊️
                </p>
              </div>
            </div>
            ...
            <div className="px-8 py-4 bg-gray-50 border-t border-gray-200 flex items-center justify-between text-base font-bold">
              <p className="text-xs sm:text-sm text-gray-500 font-serif italic">
                "Kelimelerin seyahati sabırla beklenir."
              </p>
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="px-6 py-2.5 rounded-xl bg-rose-700 hover:bg-rose-800 text-white shadow-md transition cursor-pointer flex items-center gap-2 text-base"
                >
                  <span>🕊️ Yoldaki Mektupları Gör</span>
                </button>
              </div>
            </div>
          </>
          ...
          /* =========================================================
             MEKTUP EDİTÖRÜ (STANDART GÖRÜNÜM)
             ========================================================= */
          <>
